...
output_dir = Path("downloaded_pic_3")
output_dir.mkdir(exist_ok=True)

base_url = "https://www.aptiskey.com/images/speaking/part3/"
...
for de in range(1, 26):
    de_str = f"de{de:02d}"
    for idx in [1, 2]:
        filename = f"{de_str}_{idx}.png"
        url = base_url + filename
        filepath = output_dir / filename
        download_file(url, filepath)
        time.sleep(0.3)

print("\n✅ Download completed! Files saved in 'downloaded_pic_3' folder.")
